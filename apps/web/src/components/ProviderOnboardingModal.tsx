...
import { X, Send, HardDrive, Cloud, ArrowRight, ShieldCheck, Check, AlertCircle, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm font-mono text-xs">
      <div className="bg-[#0a0a0a] border border-[#1e1e1e] rounded-lg w-full max-w-md flex flex-col overflow-hidden shadow-2xl">
        ...
        {/* Error Message Box */}
        {errorMessage && (
          <div className="m-4 p-3 bg-red-950/40 border border-red-800/60 rounded text-red-300 text-xs flex items-start gap-2">
