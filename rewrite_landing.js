...
// Rejoin all parts except the last one (in case there are multiple 'return (' strings, we want the last one which is the main render)
const preamble = parts.slice(0, -1).join('  return (') + '  return (';
const rest = parts[parts.length - 1];

// We want the preamble which is everything up to the final component return. 
// Wait, the main render return is the *first* one inside OnboardingLandingPage.
// So parts[0] is exactly what we want up to `  return (`.
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-stone-50 font-sans selection:bg-stone-50 selection:text-black overflow-x-hidden">
      ...
      <main className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="relative flex flex-col lg:flex-row items-center min-h-[60vh] md:min-h-[70vh]">
          ...
          <div className="absolute right-[-10%] top-[-10%] w-full lg:w-[120%] h-[120%] pointer-events-none opacity-80 mix-blend-screen animate-float-delayed">
          ...
          <div className="relative z-10 lg:w-1/2 flex flex-col items-start text-left mt-12 lg:mt-0">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
              ...
              <span className="text-xs font-medium text-stone-300">Your files. Your space.</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-stone-400 mb-10 max-w-lg leading-relaxed font-sans">
              Store, organize, search and share your files from one private space. Built for privacy. Built for you.
            </p>
        ...
        <div className="mt-24 mb-32 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-2 rounded-3xl bg-[#111] border border-white/5">
          ...
          <div className="p-6 flex flex-col gap-3">
            ...
            <h3 className="font-medium text-[15px]">Private by default</h3>
            <p className="text-sm text-stone-500 leading-relaxed">Your data belongs to you and only you.</p>
          </div>
          <div className="p-6 flex flex-col gap-3">
              ...
              <div className="flex flex-1 min-h-[400px]">
                ...
                <div className="w-56 border-r border-white/5 bg-[#0a0a0a]/50 p-4 flex flex-col gap-1">
                  ...
                  <div className="mt-auto pt-6 border-t border-white/5">
                    ...
                    <div className="text-xs font-medium text-stone-300 mb-2"><span className="text-white">1.24 TB</span> of 2 TB used</div>
                    <div className="h-1.5 w-full bg-[#222] rounded-full overflow-hidden">
                      <div className="h-full bg-white w-[62%] rounded-full"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 bg-[#111] p-6">
                  ...
                  <div className="flex flex-col gap-1 text-sm text-stone-300">
                    {[
                      { icon: <FolderIcon className="w-4 h-4 text-white" />, name: 'Projects', date: 'Today, 9:41 AM', size: '1.2 GB' },
                      { icon: <FolderIcon className="w-4 h-4 text-white" />, name: 'Photos', date: 'Yesterday, 3:22 PM', size: '8.4 GB' },
                      { icon: <FolderIcon className="w-4 h-4 text-white" />, name: 'Documents', date: 'May 10, 2024', size: '2.1 GB' },
                      { icon: <FileDesignIcon className="w-4 h-4 text-blue-400" />, name: 'Design System.fig', date: 'May 8, 2024', size: '24.5 MB' },
                      { icon: <FilePdfIcon className="w-4 h-4 text-red-400" />, name: 'Presentation.pdf', date: 'May 6, 2024', size: '12.1 MB' },
                      { icon: <ImageIcon className="w-4 h-4 text-green-400" />, name: 'Screenshot.png', date: 'May 3, 2024', size: '3.6 MB' },
                    ].map((item, i) => (
        ...
        <div className="mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 font-sans">
            <div className="bg-[#111] border border-white/5 rounded-3xl p-8 flex flex-col justify-between min-h-[280px]">
              ...
              <div>
                <h3 className="text-lg font-medium mb-3 text-stone-200">Smart search</h3>
                <p className="text-sm text-stone-400 leading-relaxed mb-6">Find anything instantly with powerful search across all your spaces.</p>
            ...
            <div className="bg-[#111] border border-white/5 rounded-3xl p-8 flex flex-col justify-between min-h-[280px]">
              ...
              <div>
                <h3 className="text-lg font-medium mb-3 text-stone-200">Organize easily</h3>
                <p className="text-sm text-stone-400 leading-relaxed mb-6">Use folders, collections and tags your way to keep things tidy.</p>
                <button className="text-xs font-semibold uppercase tracking-wider text-stone-300 hover:text-white flex items-center gap-1.5 transition">
                  Learn more <ArrowRight className="w-3 h-3" />
                </button>
              </div>
            ...
            <div className="bg-[#111] border border-white/5 rounded-3xl p-8 flex flex-col justify-between min-h-[280px]">
              ...
              <div>
                <h3 className="text-lg font-medium mb-3 text-stone-200">Share securely</h3>
                <p className="text-sm text-stone-400 leading-relaxed mb-6">Share files and folders with anyone you choose, with strict access controls.</p>
                <button className="text-xs font-semibold uppercase tracking-wider text-stone-300 hover:text-white flex items-center gap-1.5 transition">
                  Learn more <ArrowRight className="w-3 h-3" />
                </button>
              </div>
        ...
        <div className="relative rounded-3xl overflow-hidden bg-[#111] border border-white/5 min-h-[300px] flex items-center">
          <div className="absolute right-0 bottom-[-50%] w-full h-[200%] pointer-events-none opacity-50 mix-blend-screen animate-float">
            <div 
          ...
          <div className="relative z-10 p-12 md:p-16 max-w-xl">
            ...
            <p className="text-stone-400 leading-relaxed mb-8 font-sans">
              We don't sell your data. We don't scan your files. You're always in control of your digital life.
            </p>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="flex gap-16 lg:gap-24">
            <div className="flex flex-col gap-4 text-sm">
              ...
              <a href="#" className="text-stone-500 hover:text-stone-300">Features</a>
              ...
              <a href="#" className="text-stone-500 hover:text-stone-300">Docs</a>
            </div>
            <div className="flex flex-col gap-4 text-sm">
              <span className="font-medium mb-2 text-stone-200">Project</span>
              <a href="#" className="text-stone-500 hover:text-stone-300">Open Source</a>
              <a href="#" className="text-stone-500 hover:text-stone-300">GitHub</a>
            </div>
            <div className="flex flex-col gap-4 text-sm">
...
fs.writeFileSync('src/components/OnboardingLandingPage.tsx', parts[0] + '  return (' + new_render, 'utf-8');
console.log('Successfully updated OnboardingLandingPage.tsx');
